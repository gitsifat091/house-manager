...
const Map<String, List<String>> _divisionDistricts = {
  'ঢাকা': [
    ...
    'নরসিংদী', 'রাজবাড়ী', 'মাদারীপুর', 'গোপালগঞ্জ', 'ফরিদপুর', 'শরিয়তপুর', 'কিশোরগঞ্জ', 'টাঙ্গাইল',
  ],
  'চট্টগ্রাম': [
...
class _ListingCard extends StatelessWidget {
  ...
  Widget _locationRow(IconData icon, String label, String value, Color textPrimary, Color textSecondary) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 8),
      child: Row(
        children: [
...
class _EditListingScreenState extends State<EditListingScreen> {
  ...
  late String _selectedDivision = widget.listing.division;
  // জেলা: existing value রাখি, division change হলে reset হবে
  late String? _selectedDistrict = widget.listing.district.isNotEmpty
  ...
  Future<void> _save() async {
    ...
    if (_selectedDistrict == null) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('জেলা সিলেক্ট করুন'), backgroundColor: Colors.red));
      return;
    }
    setState(() => _loading = true);
  ...
  Widget build(BuildContext context) {
    ...
    // নিশ্চিত করি যে existing district টা current division এর list এ আছে
    final districts = _currentDistricts;
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                value: _divisionDistricts.containsKey(_selectedDivision)
                    ? _selectedDivision
                    : null,
                ...
                onChanged: (v) {
                  ...
                  setState(() {
                    _selectedDivision = v;
                    _selectedDistrict = null; // division বদলালে জেলা reset
                  });
                },
                validator: (v) => v == null ? 'বিভাগ সিলেক্ট করুন' : null,
              ),
              ...
              // জেলা dropdown — division এর উপর dependent
              DropdownButtonFormField<String>(
                key: ValueKey(_selectedDivision), // division বদলালে widget rebuild
                decoration: const InputDecoration(
                  labelText: 'জেলা',
                  prefixIcon: Icon(Icons.location_city_outlined),
                ),
                ...
                validator: (v) => v == null ? 'জেলা সিলেক্ট করুন' : null,
              ),
              const SizedBox(height: 12),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // জেলা dropdown — division এর উপর dependent
                    DropdownButtonFormField<String>(
                      key: ValueKey(_selectedDivision), // division বদলালে rebuild
                      decoration: const InputDecoration(
                        labelText: 'জেলা',
                        prefixIcon: Icon(Icons.location_city_outlined),
                      ),
