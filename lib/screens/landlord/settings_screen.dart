                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                      ...
                      _card(cardBg, divider, [
                        ...
                        // ── Two-Factor Authentication Hide by comment ──
                        // _divider(divider),
                        // _navTile(
                        //   icon: Icons.shield_outlined,
                        //   iconBg: const Color(0xFF6B7280),
                      ...
                      // ── ডেটা ও প্রাইভেসি ──
                      // ── ডেটা ও প্রাইভেসি Section Hide by comment──
                      // _sectionHeader(
                      //     '🗄️  ডেটা ও প্রাইভেসি', textSecondary),
                      // _card(cardBg, divider, [
                      //   _navTile(
                      ...
                      _card(cardBg, divider, [
                        ...
                        _navTile(
                          ...
                          iconBg: const Color(0xFF5B4FBF),
                          title: 'যোগাযোগ করুন',
                          subtitle: 'সাহায্য ও সমস্যার জন্য',
                          textPrimary: textPrimary,
                          textSecondary: textSecondary,
      ...
      builder: (_) => DraggableScrollableSheet(
        ...
        builder: (_, ctrl) => Column(
          children: [
            ...
            Text('আমরা সাহায্য করতে প্রস্তুত',
                ...
                children: [
                  ...
                  Text('সাধারণ প্রশ্ন',
                      style: TextStyle(
                          ...
                          letterSpacing: 0.5)),
                  const SizedBox(height: 10),
                  _faqTile('ভাড়া payment কীভাবে করব?',
                      'ভাড়া ট্যাব থেকে মাসের payment select করে submit করুন।', isDark),
                  _faqTile('নোটিশ কীভাবে দেখব?',
                      'নোটিশ ট্যাব থেকে বাড়ীওয়ালার সব নোটিশ দেখা যাবে।', isDark),
                  _faqTile('মেরামতের অনুরোধ কীভাবে করব?',
                      'মেরামত ট্যাব থেকে নতুন অনুরোধ পাঠান।', isDark),
                  _faqTile('Password ভুলে গেলে কী করব?',
                      'Login পেজে "Password ভুলে গেছেন?" বাটনে ক্লিক করুন।', isDark),
                ],
              ),
            ),
          ],
