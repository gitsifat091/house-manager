...
//         children: [
//           // ── Profile Header ──────────────────────────
//           _TenantDrawerHeader(user: user, primary: primary, isDark: isDark),
...
//                     Navigator.pop(context);
//                     Navigator.push(context, MaterialPageRoute(
//                       builder: (_) => TenantCommunityChatScreen(user: user),
//                     ));
//                   },
//                 ),
//                 _DrawerTile(
...
// class _TenantDrawerHeader extends StatelessWidget {
//   final dynamic user;
//   final Color primary;
//   final bool isDark;
//   const _TenantDrawerHeader({required this.user, required this.primary, required this.isDark});
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _DrawerSectionLabel('আমার ইতিহাস', textSecondary),

                _DrawerTile(
                  icon: Icons.history_rounded,
                  iconBg: const Color(0xFF5B4FBF),
                  label: 'পূর্বের ইতিহাস',
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.push(context, MaterialPageRoute(
                      builder: (_) => const TenantHistoryScreen(),
                    ));
                  },
                ),
